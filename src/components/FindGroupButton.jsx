...
function FindGroupButton() {
  ...
  const handleSearch = async () => {
    ...
    try {
      const response = await fetch(`https://localhost:8080/api/classes/${classId}`, {
        credentials: 'include'
      });
  ...
  const handleJoinClass = async () => {
    ...
    try {
      const response = await fetch(`https://localhost:8080/api/student-class/join/${classInfo.id}`, {
        method: 'POST',
        credentials: 'include',
        headers: {
